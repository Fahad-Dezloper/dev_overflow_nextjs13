...
const Theme = () => {
  ...
  return (
          <Menubar className='realtive border-none bg-transparent shadow-none'>
                <MenubarMenu>
              <MenubarTrigger
              className="dark:data=[state=open]:bg-dark-200 focus:bg-light-900 data-[state=open]:bg-light-900 dark:focus:bg-dark-200"
              >
                  {mode === 'light' ? (
